...
public class OAuth2ResourceOwnerPasswordAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        if (!Objects.requireNonNull(registeredClient).getAuthorizationGrantTypes().contains(AuthorizationGrantType.PASSWORD)) {
        ...
        try {
            ...
            if (log.isDebugEnabled()) {
                log.debug("Got the username password authentication token:{}", usernamePasswordAuthenticationToken);
            }
            ...
            JwtClaimsSet.Builder claimsBuilder = JwtUtils.accessTokenClaims(registeredClient, issuer, usernamePasswordAuthentication.getName(), authorizedScopes);
